    ...
    <nav class="pcoded-navbar">
        <div class="navbar-wrapper">
            <div class="navbar-brand header-logo">
               <a href="adm-page.jsp?pgprt=0" class="b-brand">
               	   <div class="b-bg">
			...
			<header class="MuiPaper-root-295 MuiAppBar-root-284 jss356 MuiAppBar-positionStatic-288 MuiAppBar-colorPrimary-291 user relative flex flex-col items-center justify-center pt-24 pb-64 mb-32 z-0 MuiPaper-elevation0-298">
				...
				<p class="MuiTypography-root-325 email text-13 mt-8 opacity-50 whitespace-no-wrap MuiTypography-body1-327 MuiTypography-colorInherit-347">Admin</p>
                ...
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="dashboard Default Ecommerce CRM Analytics Crypto Project" class="nav-item">
                        <a href="adm-page.jsp?pgprt=0" class="nav-link "><span class="pcoded-micon"><i class="feather icon-grid"></i></span><span class="pcoded-mtext">Dashboard</span></a>
                    </li>
                    
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="adm-page.jsp?pgprt=6" class="nav-link "><span class="pcoded-micon"><i class="feather icon-user"></i></span><span class="pcoded-mtext">Profile</span></a>
                    </li>
                    
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="adm-page.jsp?pgprt=2" class="nav-link "><span class="pcoded-micon"><i class="feather icon-book"></i></span><span class="pcoded-mtext">Courses</span></a>
                    </li>
                  
                    <li data-username="form elements advance componant validation masking wizard picker select" class="nav-item">
                        <a href="adm-page.jsp?pgprt=3" class="nav-link "><span class="pcoded-micon"><i class="feather icon-help-circle"></i></span><span class="pcoded-mtext">Questions</span></a>
                    </li>
                    <li data-username="Table bootstrap datatable footable" class="nav-item">
                        <a href="adm-page.jsp?pgprt=1" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users"></i></span><span class="pcoded-mtext">Users</span></a>
                    </li>
                    <li data-username="Table bootstrap datatable footable" class="nav-item">
                        <a href="adm-page.jsp?pgprt=5" class="nav-link "><span class="pcoded-micon"><i class="feather icon-award"></i></span><span class="pcoded-mtext">Results</span></a>
                    </li>
            		...
            		<div class="flex">
            			<button class="MuiButtonBase-root-86 MuiButton-root-59 MuiButton-text-61 h-64" tabindex="0" type="button">
            				...
            				<a href="adm-page.jsp?pgprt=6">
            					<div class="MuiAvatar-root-87 MuiAvatar-circle-89">
            						<img src="images/<%=image%>"></a>
            					</div>
            					<div class="hidden md:flex flex-col mx-12 items-start"><a href="adm-page.jsp?pgprt=6">
            					...
            					<i class="feather icon-eye mx-4_1" style="font-size:15px;"></i>
            				</a>
            				</span>
...
<script src="js/vendor-all.min.js"></script>
	...
	<script src="https://cdn.auth0.com/client/h6F2vzBzGs2FT0KBvtDfIntGJtO0kAlB.js?t1593252833580"></script>
