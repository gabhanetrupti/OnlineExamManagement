...
$('body').append('' +
'<div class="fixed-button">' + '<img src="images/app/shiv_Ba.gif" style="float:right;height:70px;width:70px;padding-top: 0px;padding-right: 15px;padding-bottom: 15px;"> ' + '</div>' + '');
