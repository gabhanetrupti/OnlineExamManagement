...
*/
    ...
    pDAO.addNewStudent(uName,email,pass);
    response.sendRedirect("adm-page.jsp?pgprt=1");
}
       ...
       String fName =request.getParameter("fname");
        ...
        String address =request.getParameter("address");
         ...
         String u_Image =request.getParameter("file");
        int uid=Integer.parseInt(session.getAttribute("userId").toString());      
        
    pDAO.updateStudent(uid,fName,lName,uName,email,pass,contactNo,city,address,uType,u_Image);
    response.sendRedirect("dashboard.jsp");
