	...
	<!------------- Necessary end --------------->                 
		...
		<div class="row">
			<div class="col-md-6 col-xl-3">
				<div class="col-md-12 col-xl-12 b-bg_4">
                      <div class="row d-flex align-items-center">                       
                         <div class="text-right">
                              <p class="m-b-0">Register a <br><h1>Course</h1></p> 
                             <br>                             
                             <a href="adm-page.jsp?pgprt=2" class="nav-link "><span class="pcoded-micon"><i class="feather icon-book"></i></span>&nbsp<span class="pcoded-mtext">Register&nbspnow</span></a>
                         </div>
                      </div>
	                ...
	                <div class="absolute2">
	                	<img src="images/app/course_pic.png">
	                </div>	                
                </div>
				...
				<div class="col-md-12 col-xl-12 b-bg_2">
                      <div class="row d-flex align-items-center">                       
                         <div class="text-right m-b-0">
                              <p class="m-b-0">Set course wise<br><h1>&nbspQuestions</h1></p> 
                             <br>
                             <a href="adm-page.jsp?pgprt=3" class="nav-link "><span class="pcoded-micon"><i class="feather icon-help-circle"></i></span>&nbsp<span class="pcoded-mtext">Set now</span></a>
                         </div>
                      </div>
                      <div class="progress m-t-30" style="height: 7px;">
                         <div class="progress-bar progress-c-theme" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
	                ...
	                <div class="absolute2">
	                	<img src="images/app/question_pic.png">
	                </div>	                
                </div>
            ...
            <div class="col-md-6 col-xl-3">
				<div class="col-md-12 col-xl-12 b-bg_6">
                      <div class="row d-flex align-items-center">                       
                         <div class="text-right m-b-0">
                              <p class="m-b-0">See all<br><h1>Users</h1></p> 
                             <br>
                             <a href="adm-page.jsp?pgprt=1" class="nav-link "><span class="pcoded-micon"><i class="feather icon-users"></i></span>&nbsp<span class="pcoded-mtext">See now</span></a>
                         </div>
                      </div>
                      <div class="progress m-t-30" style="height: 7px;">
                         <div class="progress-bar progress-c-theme" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
	                ...
	                <div class="absolute2">
	                	<img src="images/app/accounts_pic.png">
	                </div>	                
                </div>
            ...
            <div class="col-md-6 col-xl-3">
				<div class="col-md-12 col-xl-12 b-bg_7">
                      <div class="row d-flex align-items-center">                       
                         <div class="text-right m-b-0">
                              <p class="m-b-0">&nbspSee course wise<br><h1>&nbspResults</h1></p> 
                             <br>
                             <a href="adm-page.jsp?pgprt=5" class="nav-link "><span class="pcoded-micon"><i class="feather icon-award"></i></span>&nbsp<span class="pcoded-mtext">See now</span></a>
                         </div>
                      </div>
                      <div class="progress m-t-30" style="height: 7px;">
                         <div class="progress-bar progress-c-theme" role="progressbar" style="width: 50%;" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100"></div>
